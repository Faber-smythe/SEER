...
class World
{
    ...
    /**
     * @var null|File
     * @Vich\UploadableField(mapping="world_image", fileNameProperty="filename")
     */
    private $imageFile;
     ...
     * @return World
     */
    public function setFilename(?string $filename): World
    {
     ...
     * @return World
     */
    public function setImageFile(?File $imageFile): World
    {
